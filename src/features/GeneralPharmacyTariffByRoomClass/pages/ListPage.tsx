...
const columns: ColumnDef<PharmacyTariffByRoomClass, unknown>[] = [
  {
...
export function PharmacyTariffByRoomClassListPage() {
  const resource = usePharmacyTariffByRoomClassResource()
  const title = humanizeModuleName('GeneralPharmacyTariffByRoomClass')

  return (
    <CrudDialogPage<PharmacyTariffByRoomClass>
      title={title}
