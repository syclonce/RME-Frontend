...
const columns: ColumnDef<PenjaminRSClaimDriver, unknown>[] = [
  {
...
export function PenjaminRSClaimDriverListPage() {
  const resource = usePenjaminRSClaimDriverResource()
  const title = humanizeModuleName('PenjaminRSClaimDriver')

  return (
    <CrudDialogPage<PenjaminRSClaimDriver>
      title={title}
