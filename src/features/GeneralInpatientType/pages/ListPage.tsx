...
const columns: ColumnDef<InpatientType, unknown>[] = [
  {
...
export function InpatientTypeListPage() {
  const resource = useInpatientTypeResource()
  const title = humanizeModuleName('GeneralInpatientType')

  return (
    <CrudDialogPage<InpatientType>
      title={title}
