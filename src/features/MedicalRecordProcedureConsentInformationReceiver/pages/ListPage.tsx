  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-lg font-semibold">ProcedureConsentInformationReceiver</h1>
        <Button asChild>
          <Link to="/modul/medical-record-procedure-consent-information-receiver/tambah">Tambah</Link>
        </Button>
      </div>
      <Table>
        <TableHeader>
