...
const columns: ColumnDef<AnatomyTemplate, unknown>[] = [
  {
...
export function AnatomyTemplateListPage() {
  const resource = useAnatomyTemplateResource()
  const title = humanizeModuleName('GeneralAnatomyTemplate')

  return (
    <CrudDialogPage<AnatomyTemplate>
      title={title}
