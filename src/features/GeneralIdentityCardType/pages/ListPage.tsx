...
const columns: ColumnDef<IdentityCardType, unknown>[] = [
  {
...
export function IdentityCardTypeListPage() {
  const resource = useIdentityCardTypeResource()
  const title = humanizeModuleName('GeneralIdentityCardType')

  return (
    <CrudDialogPage<IdentityCardType>
      title={title}
