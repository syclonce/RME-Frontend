...
const columns: ColumnDef<MaritalStatus, unknown>[] = [
  {
...
export function MaritalStatusListPage() {
  const resource = useMaritalStatusResource()
  const title = humanizeModuleName('GeneralMaritalStatus')

  return (
    <CrudDialogPage<MaritalStatus>
      title={title}
