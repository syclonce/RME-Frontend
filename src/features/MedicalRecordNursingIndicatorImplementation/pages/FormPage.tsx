...
export function NursingIndicatorImplementationFormPage() {
  ...
  return (
    <form
      ...
      onSubmit={(e) => {
        e.preventDefault()
        create.mutate(values, { onSuccess: () => navigate('/modul/medical-record-nursing-indicator-implementation') })
      }}
    >
      ...
      <div className="grid gap-1.5">
        ...
        <RelationSelect
          endpoint="/nursing-indicators"
          value={values.nursing_indicator_id ?? null}
          onChange={(v) => setValues({ ...values, nursing_indicator_id: v })}
        />
      </div>
      <div className="grid gap-1.5">
