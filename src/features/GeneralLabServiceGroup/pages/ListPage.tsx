...
const columns: ColumnDef<LabServiceGroup, unknown>[] = [
  {
...
export function LabServiceGroupListPage() {
  const resource = useLabServiceGroupResource()
  const title = humanizeModuleName('GeneralLabServiceGroup')

  return (
    <CrudDialogPage<LabServiceGroup>
      title={title}
