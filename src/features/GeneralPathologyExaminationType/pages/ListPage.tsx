...
const columns: ColumnDef<PathologyExaminationType, unknown>[] = [
  {
...
export function PathologyExaminationTypeListPage() {
  const resource = usePathologyExaminationTypeResource()
  const title = humanizeModuleName('GeneralPathologyExaminationType')

  return (
    <CrudDialogPage<PathologyExaminationType>
      title={title}
