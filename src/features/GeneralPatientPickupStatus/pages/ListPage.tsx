...
const columns: ColumnDef<PatientPickupStatus, unknown>[] = [
  {
...
export function PatientPickupStatusListPage() {
  const resource = usePatientPickupStatusResource()
  const title = humanizeModuleName('GeneralPatientPickupStatus')

  return (
    <CrudDialogPage<PatientPickupStatus>
      title={title}
