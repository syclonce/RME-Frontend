...
const columns: ColumnDef<FamilyRelationship, unknown>[] = [
  {
...
export function FamilyRelationshipListPage() {
  const resource = useFamilyRelationshipResource()
  const title = humanizeModuleName('GeneralFamilyRelationship')

  return (
    <CrudDialogPage<FamilyRelationship>
      title={title}
