...
const columns: ColumnDef<SitbChestXrayResult, unknown>[] = [
  {
...
export function SitbChestXrayResultListPage() {
  const resource = useSitbChestXrayResultResource()
  const title = humanizeModuleName('GeneralSitbChestXrayResult')

  return (
    <CrudDialogPage<SitbChestXrayResult>
      title={title}
