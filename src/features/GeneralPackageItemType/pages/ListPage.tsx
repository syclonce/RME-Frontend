...
const columns: ColumnDef<PackageItemType, unknown>[] = [
  {
...
export function PackageItemTypeListPage() {
  const resource = usePackageItemTypeResource()
  const title = humanizeModuleName('GeneralPackageItemType')

  return (
    <CrudDialogPage<PackageItemType>
      title={title}
