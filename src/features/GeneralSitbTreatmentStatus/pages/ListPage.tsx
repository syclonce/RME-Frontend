...
const columns: ColumnDef<SitbTreatmentStatus, unknown>[] = [
  {
...
export function SitbTreatmentStatusListPage() {
  const resource = useSitbTreatmentStatusResource()
  const title = humanizeModuleName('GeneralSitbTreatmentStatus')

  return (
    <CrudDialogPage<SitbTreatmentStatus>
      title={title}
