  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        ...
        <Input id="transferred_to_ward_id" type="number" value={values.transferred_to_ward_id ?? ''} onChange={(e) => setValues({ ...values, transferred_to_ward_id: e.target.value === '' ? null : Number(e.target.value) })} />
      </div>
      <div className="grid gap-1.5">
