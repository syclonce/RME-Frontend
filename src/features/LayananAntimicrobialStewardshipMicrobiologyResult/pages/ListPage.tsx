  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-lg font-semibold">AntimicrobialStewardshipMicrobiologyResult</h1>
        <Button asChild>
          <Link to="/modul/layanan-antimicrobial-stewardship-microbiology-result/tambah">Tambah</Link>
        </Button>
      </div>
      <Table>
        <TableHeader>
