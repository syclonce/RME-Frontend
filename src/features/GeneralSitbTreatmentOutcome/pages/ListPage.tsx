...
const columns: ColumnDef<SitbTreatmentOutcome, unknown>[] = [
  {
...
export function SitbTreatmentOutcomeListPage() {
  const resource = useSitbTreatmentOutcomeResource()
  const title = humanizeModuleName('GeneralSitbTreatmentOutcome')

  return (
    <CrudDialogPage<SitbTreatmentOutcome>
      title={title}
