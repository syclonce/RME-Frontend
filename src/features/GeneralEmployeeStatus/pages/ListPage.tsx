...
const columns: ColumnDef<EmployeeStatus, unknown>[] = [
  {
...
export function EmployeeStatusListPage() {
  const resource = useEmployeeStatusResource()
  const title = humanizeModuleName('GeneralEmployeeStatus')

  return (
    <CrudDialogPage<EmployeeStatus>
      title={title}
