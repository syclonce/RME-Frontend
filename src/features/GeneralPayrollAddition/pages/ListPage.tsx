...
const columns: ColumnDef<PayrollAddition, unknown>[] = [
  {
...
export function PayrollAdditionListPage() {
  const resource = usePayrollAdditionResource()
  const title = humanizeModuleName('GeneralPayrollAddition')

  return (
    <CrudDialogPage<PayrollAddition>
      title={title}
