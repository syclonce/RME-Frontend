...
const columns: ColumnDef<TreatmentCategory, unknown>[] = [
  {
...
export function TreatmentCategoryListPage() {
  const resource = useTreatmentCategoryResource()
  const title = humanizeModuleName('GeneralTreatmentCategory')

  return (
    <CrudDialogPage<TreatmentCategory>
      title={title}
