...
const columns: ColumnDef<OtherStatus, unknown>[] = [
  {
...
export function OtherStatusListPage() {
  const resource = useOtherStatusResource()
  const title = humanizeModuleName('GeneralOtherStatus')

  return (
    <CrudDialogPage<OtherStatus>
      title={title}
