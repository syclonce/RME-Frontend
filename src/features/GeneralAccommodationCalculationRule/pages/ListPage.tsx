...
const columns: ColumnDef<AccommodationCalculationRule, unknown>[] = [
  {
...
export function AccommodationCalculationRuleListPage() {
  const resource = useAccommodationCalculationRuleResource()
  const title = humanizeModuleName('GeneralAccommodationCalculationRule')

  return (
    <CrudDialogPage<AccommodationCalculationRule>
      title={title}
