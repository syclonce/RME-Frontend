...
const columns: ColumnDef<SitbDrugSource, unknown>[] = [
  {
...
export function SitbDrugSourceListPage() {
  const resource = useSitbDrugSourceResource()
  const title = humanizeModuleName('GeneralSitbDrugSource')

  return (
    <CrudDialogPage<SitbDrugSource>
      title={title}
