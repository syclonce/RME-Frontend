...
const columns: ColumnDef<Administration, unknown>[] = [
  {
...
export function AdministrationListPage() {
  const resource = useAdministrationResource()
  const title = humanizeModuleName('GeneralAdministration')

  return (
    <CrudDialogPage<Administration>
      title={title}
