...
const columns: ColumnDef<RoomClassReferenceGroup, unknown>[] = [
  {
...
export function RoomClassReferenceGroupListPage() {
  const resource = useRoomClassReferenceGroupResource()
  const title = humanizeModuleName('GeneralRoomClassReferenceGroup')

  return (
    <CrudDialogPage<RoomClassReferenceGroup>
      title={title}
