...
const columns: ColumnDef<ReferralRoom, unknown>[] = [
  {
...
export function ReferralRoomListPage() {
  const resource = useReferralRoomResource()
  const title = humanizeModuleName('GeneralReferralRoom')

  return (
    <CrudDialogPage<ReferralRoom>
      title={title}
