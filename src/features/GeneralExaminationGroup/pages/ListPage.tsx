...
const columns: ColumnDef<ExaminationGroup, unknown>[] = [
  {
...
export function ExaminationGroupListPage() {
  const resource = useExaminationGroupResource()
  const title = humanizeModuleName('GeneralExaminationGroup')

  return (
    <CrudDialogPage<ExaminationGroup>
      title={title}
