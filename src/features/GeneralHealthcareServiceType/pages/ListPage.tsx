...
const columns: ColumnDef<HealthcareServiceType, unknown>[] = [
  {
...
export function HealthcareServiceTypeListPage() {
  const resource = useHealthcareServiceTypeResource()
  const title = humanizeModuleName('GeneralHealthcareServiceType')

  return (
    <CrudDialogPage<HealthcareServiceType>
      title={title}
