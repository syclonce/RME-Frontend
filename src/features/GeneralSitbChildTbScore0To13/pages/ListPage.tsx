...
const columns: ColumnDef<SitbChildTbScore0To13, unknown>[] = [
  {
...
export function SitbChildTbScore0To13ListPage() {
  const resource = useSitbChildTbScore0To13Resource()
  const title = humanizeModuleName('GeneralSitbChildTbScore0To13')

  return (
    <CrudDialogPage<SitbChildTbScore0To13>
      title={title}
