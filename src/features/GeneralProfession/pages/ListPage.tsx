...
const columns: ColumnDef<Profession, unknown>[] = [
  {
...
export function ProfessionListPage() {
  const resource = useProfessionResource()
  const title = humanizeModuleName('GeneralProfession')

  return (
    <CrudDialogPage<Profession>
      title={title}
