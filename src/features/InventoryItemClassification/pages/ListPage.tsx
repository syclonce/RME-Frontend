...
const columns: ColumnDef<InventoryItemClassification, unknown>[] = [
  {
...
export function InventoryItemClassificationListPage() {
  const resource = useInventoryItemClassificationResource()
  const title = humanizeModuleName('InventoryItemClassification')

  return (
    <CrudDialogPage<InventoryItemClassification>
      title={title}
