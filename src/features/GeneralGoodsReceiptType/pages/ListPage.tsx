...
const columns: ColumnDef<GoodsReceiptType, unknown>[] = [
  {
...
export function GoodsReceiptTypeListPage() {
  const resource = useGoodsReceiptTypeResource()
  const title = humanizeModuleName('GeneralGoodsReceiptType')

  return (
    <CrudDialogPage<GoodsReceiptType>
      title={title}
