...
const columns: ColumnDef<PainOnsetType, unknown>[] = [
  {
...
export function PainOnsetTypeListPage() {
  const resource = usePainOnsetTypeResource()
  const title = humanizeModuleName('GeneralPainOnsetType')

  return (
    <CrudDialogPage<PainOnsetType>
      title={title}
