...
const columns: ColumnDef<NursingIndicatorType, unknown>[] = [
  {
...
export function NursingIndicatorTypeListPage() {
  const resource = useNursingIndicatorTypeResource()
  const title = humanizeModuleName('MedicalRecordNursingIndicatorType')

  return (
    <CrudDialogPage<NursingIndicatorType>
      title={title}
