...
const columns: ColumnDef<WardVisitType, unknown>[] = [
  {
...
export function WardVisitTypeListPage() {
  const resource = useWardVisitTypeResource()
  const title = humanizeModuleName('GeneralWardVisitType')

  return (
    <CrudDialogPage<WardVisitType>
      title={title}
