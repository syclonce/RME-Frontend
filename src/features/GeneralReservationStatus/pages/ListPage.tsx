...
const columns: ColumnDef<ReservationStatus, unknown>[] = [
  {
...
export function ReservationStatusListPage() {
  const resource = useReservationStatusResource()
  const title = humanizeModuleName('GeneralReservationStatus')

  return (
    <CrudDialogPage<ReservationStatus>
      title={title}
