...
const COLUMNS = ["id","claim_file_id","prescription_id","submitted_at","status","created_at"] as const
  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-lg font-semibold">PharmacyClaim</h1>
        <Button asChild>
          <Link to="/modul/berkas-klaim-pharmacy-claim/tambah">Tambah</Link>
        </Button>
      </div>
      <Table>
        <TableHeader>
