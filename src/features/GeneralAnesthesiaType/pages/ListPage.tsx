...
const columns: ColumnDef<AnesthesiaType, unknown>[] = [
  {
...
export function AnesthesiaTypeListPage() {
  const resource = useAnesthesiaTypeResource()
  const title = humanizeModuleName('GeneralAnesthesiaType')

  return (
    <CrudDialogPage<AnesthesiaType>
      title={title}
