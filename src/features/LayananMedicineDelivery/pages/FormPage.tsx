...
export function MedicineDeliveryFormPage() {
  ...
  const { create, update, useDetail } = useMedicineDeliveryResource()
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        ...
        <RelationSelect
          endpoint="/pharmacy-dispenses"
          value={values.pharmacy_dispense_id ?? null}
          onChange={(v) => setValues({ ...values, pharmacy_dispense_id: v })}
        />
      </div>
      <div className="grid gap-1.5">
