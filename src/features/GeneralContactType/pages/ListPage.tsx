...
const columns: ColumnDef<ContactType, unknown>[] = [
  {
...
export function ContactTypeListPage() {
  const resource = useContactTypeResource()
  const title = humanizeModuleName('GeneralContactType')

  return (
    <CrudDialogPage<ContactType>
      title={title}
