...
const columns: ColumnDef<TbPatientCategory, unknown>[] = [
  {
...
export function TbPatientCategoryListPage() {
  const resource = useTbPatientCategoryResource()
  const title = humanizeModuleName('GeneralTbPatientCategory')

  return (
    <CrudDialogPage<TbPatientCategory>
      title={title}
