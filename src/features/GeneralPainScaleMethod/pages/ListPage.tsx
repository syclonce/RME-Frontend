...
const columns: ColumnDef<PainScaleMethod, unknown>[] = [
  {
...
export function PainScaleMethodListPage() {
  const resource = usePainScaleMethodResource()
  const title = humanizeModuleName('GeneralPainScaleMethod')

  return (
    <CrudDialogPage<PainScaleMethod>
      title={title}
