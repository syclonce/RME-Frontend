...
const columns: ColumnDef<ReferralStatus, unknown>[] = [
  {
...
export function ReferralStatusListPage() {
  const resource = useReferralStatusResource()
  const title = humanizeModuleName('GeneralReferralStatus')

  return (
    <CrudDialogPage<ReferralStatus>
      title={title}
