...
const columns: ColumnDef<SitbDmTherapy, unknown>[] = [
  {
...
export function SitbDmTherapyListPage() {
  const resource = useSitbDmTherapyResource()
  const title = humanizeModuleName('GeneralSitbDmTherapy')

  return (
    <CrudDialogPage<SitbDmTherapy>
      title={title}
