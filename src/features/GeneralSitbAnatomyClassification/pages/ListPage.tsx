...
const columns: ColumnDef<SitbAnatomyClassification, unknown>[] = [
  {
...
export function SitbAnatomyClassificationListPage() {
  const resource = useSitbAnatomyClassificationResource()
  const title = humanizeModuleName('GeneralSitbAnatomyClassification')

  return (
    <CrudDialogPage<SitbAnatomyClassification>
      title={title}
