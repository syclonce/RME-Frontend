...
const columns: ColumnDef<FacilityOwnershipType, unknown>[] = [
  {
...
export function FacilityOwnershipTypeListPage() {
  const resource = useFacilityOwnershipTypeResource()
  const title = humanizeModuleName('GeneralFacilityOwnershipType')

  return (
    <CrudDialogPage<FacilityOwnershipType>
      title={title}
