...
import { MedicalRecordAdmissionMedicationReconciliationEndpoint, useAdmissionMedicationReconciliationResource } from '../api'
import type { AdmissionMedicationReconciliation } from '../types'

const columns: ColumnDef<AdmissionMedicationReconciliation, unknown>[] = [
  {
...
const actions: WorkflowAction<AdmissionMedicationReconciliation>[] = []

export function AdmissionMedicationReconciliationListPage() {
  const resource = useAdmissionMedicationReconciliationResource()
  const title = humanizeModuleName('MedicalRecordAdmissionMedicationReconciliation')

  return (
    <WorkflowListPage<AdmissionMedicationReconciliation>
      title={title}
      description={`Kelola data ${title.toLowerCase()}.`}
      endpoint={MedicalRecordAdmissionMedicationReconciliationEndpoint}
      columns={columns}
