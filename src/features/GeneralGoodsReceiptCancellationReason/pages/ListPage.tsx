...
const columns: ColumnDef<GoodsReceiptCancellationReason, unknown>[] = [
  {
...
export function GoodsReceiptCancellationReasonListPage() {
  const resource = useGoodsReceiptCancellationReasonResource()
  const title = humanizeModuleName('GeneralGoodsReceiptCancellationReason')

  return (
    <CrudDialogPage<GoodsReceiptCancellationReason>
      title={title}
