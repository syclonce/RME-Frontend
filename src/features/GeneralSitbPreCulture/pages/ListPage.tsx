...
const columns: ColumnDef<SitbPreCulture, unknown>[] = [
  {
...
export function SitbPreCultureListPage() {
  const resource = useSitbPreCultureResource()
  const title = humanizeModuleName('GeneralSitbPreCulture')

  return (
    <CrudDialogPage<SitbPreCulture>
      title={title}
