...
const columns: ColumnDef<SitbReferrerType, unknown>[] = [
  {
...
export function SitbReferrerTypeListPage() {
  const resource = useSitbReferrerTypeResource()
  const title = humanizeModuleName('GeneralSitbReferrerType')

  return (
    <CrudDialogPage<SitbReferrerType>
      title={title}
