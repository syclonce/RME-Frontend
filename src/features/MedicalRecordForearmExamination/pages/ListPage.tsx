...
const columns: ColumnDef<ForearmExamination, unknown>[] = [
  {
...
export function ForearmExaminationListPage() {
  const resource = useForearmExaminationResource()
  const title = humanizeModuleName('MedicalRecordForearmExamination')

  return (
    <CrudDialogPage<ForearmExamination>
      title={title}
