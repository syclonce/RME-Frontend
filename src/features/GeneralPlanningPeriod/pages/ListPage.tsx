...
const columns: ColumnDef<PlanningPeriod, unknown>[] = [
  {
...
export function PlanningPeriodListPage() {
  const resource = usePlanningPeriodResource()
  const title = humanizeModuleName('GeneralPlanningPeriod')

  return (
    <CrudDialogPage<PlanningPeriod>
      title={title}
