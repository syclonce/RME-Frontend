...
const columns: ColumnDef<OperationType, unknown>[] = [
  {
...
export function OperationTypeListPage() {
  const resource = useOperationTypeResource()
  const title = humanizeModuleName('GeneralOperationType')

  return (
    <CrudDialogPage<OperationType>
      title={title}
