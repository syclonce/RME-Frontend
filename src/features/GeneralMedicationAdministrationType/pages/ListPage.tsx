...
const columns: ColumnDef<MedicationAdministrationType, unknown>[] = [
  {
...
export function MedicationAdministrationTypeListPage() {
  const resource = useMedicationAdministrationTypeResource()
  const title = humanizeModuleName('GeneralMedicationAdministrationType')

  return (
    <CrudDialogPage<MedicationAdministrationType>
      title={title}
