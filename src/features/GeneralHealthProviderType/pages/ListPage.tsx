...
const columns: ColumnDef<HealthProviderType, unknown>[] = [
  {
...
export function HealthProviderTypeListPage() {
  const resource = useHealthProviderTypeResource()
  const title = humanizeModuleName('GeneralHealthProviderType')

  return (
    <CrudDialogPage<HealthProviderType>
      title={title}
