...
const columns: ColumnDef<PositionTitle, unknown>[] = [
  {
...
export function PositionTitleListPage() {
  const resource = usePositionTitleResource()
  const title = humanizeModuleName('GeneralPositionTitle')

  return (
    <CrudDialogPage<PositionTitle>
      title={title}
