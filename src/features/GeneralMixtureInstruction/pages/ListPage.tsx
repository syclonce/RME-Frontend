...
const columns: ColumnDef<MixtureInstruction, unknown>[] = [
  {
...
export function MixtureInstructionListPage() {
  const resource = useMixtureInstructionResource()
  const title = humanizeModuleName('GeneralMixtureInstruction')

  return (
    <CrudDialogPage<MixtureInstruction>
      title={title}
