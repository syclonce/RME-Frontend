...
const columns: ColumnDef<Occupation, unknown>[] = [
  {
...
export function OccupationListPage() {
  const resource = useOccupationResource()
  const title = humanizeModuleName('GeneralOccupation')

  return (
    <CrudDialogPage<Occupation>
      title={title}
