...
export function DischargeMedicationReconciliationItemListPage() {
  const { useList } = useDischargeMedicationReconciliationItemResource()
  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-lg font-semibold">DischargeMedicationReconciliationItem</h1>
        <Button asChild>
          <Link to="/modul/medical-record-discharge-medication-reconciliation-item/tambah">Tambah</Link>
        </Button>
      </div>
      <Table>
        <TableHeader>
