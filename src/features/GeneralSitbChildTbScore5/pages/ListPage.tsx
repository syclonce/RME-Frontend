...
const columns: ColumnDef<SitbChildTbScore5, unknown>[] = [
  {
...
export function SitbChildTbScore5ListPage() {
  const resource = useSitbChildTbScore5Resource()
  const title = humanizeModuleName('GeneralSitbChildTbScore5')

  return (
    <CrudDialogPage<SitbChildTbScore5>
      title={title}
