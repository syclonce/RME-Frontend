...
const columns: ColumnDef<ActiveIngredient, unknown>[] = [
  {
...
export function ActiveIngredientListPage() {
  const resource = useActiveIngredientResource()
  const title = humanizeModuleName('GeneralActiveIngredient')

  return (
    <CrudDialogPage<ActiveIngredient>
      title={title}
