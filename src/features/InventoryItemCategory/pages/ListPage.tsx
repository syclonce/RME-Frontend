...
const columns: ColumnDef<InventoryItemCategory, unknown>[] = [
  {
...
export function InventoryItemCategoryListPage() {
  const resource = useInventoryItemCategoryResource()
  const title = humanizeModuleName('InventoryItemCategory')

  return (
    <CrudDialogPage<InventoryItemCategory>
      title={title}
