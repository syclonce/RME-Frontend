...
export function LeftoverMedicationVoucherItemListPage() {
  const { useList } = useLeftoverMedicationVoucherItemResource()
  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-lg font-semibold">LeftoverMedicationVoucherItem</h1>
        <Button asChild>
          <Link to="/modul/layanan-leftover-medication-voucher-item/tambah">Tambah</Link>
        </Button>
      </div>
      <Table>
        <TableHeader>
