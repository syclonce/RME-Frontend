...
export function LeftoverMedicationVoucherItemFormPage() {
  ...
  return (
    <form
      ...
      onSubmit={(e) => {
        e.preventDefault()
        create.mutate(values, { onSuccess: () => navigate('/modul/layanan-leftover-medication-voucher-item') })
      }}
    >
      ...
      <div className="grid gap-1.5">
        ...
        <RelationSelect
          endpoint="/leftover-medication-vouchers"
          value={values.leftover_medication_voucher_id ?? null}
          onChange={(v) => setValues({ ...values, leftover_medication_voucher_id: v })}
        />
      </div>
      <div className="grid gap-1.5">
