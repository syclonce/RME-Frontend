...
const columns: ColumnDef<PaymentType, unknown>[] = [
  {
...
export function PaymentTypeListPage() {
  const resource = usePaymentTypeResource()
  const title = humanizeModuleName('GeneralPaymentType')

  return (
    <CrudDialogPage<PaymentType>
      title={title}
