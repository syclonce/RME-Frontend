...
const columns: ColumnDef<InventoryUnitOfMeasure, unknown>[] = [
  {
  ...
  {
    header: humanizeField('abbreviation'),
    accessorKey: 'abbreviation',
    cell: ({ row }) => String((row.original as unknown as Record<string, unknown>).abbreviation ?? '—'),
  },
  {
...
const fields: CrudField[] = [
  ...
  { key: 'abbreviation', label: humanizeField('abbreviation') },
...
export function InventoryUnitOfMeasureListPage() {
  const resource = useInventoryUnitOfMeasureResource()
  const title = humanizeModuleName('InventoryUnitOfMeasure')

  return (
    <CrudDialogPage<InventoryUnitOfMeasure>
      title={title}
