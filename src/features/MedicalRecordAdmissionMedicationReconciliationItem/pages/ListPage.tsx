  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-lg font-semibold">AdmissionMedicationReconciliationItem</h1>
        <Button asChild>
          <Link to="/modul/medical-record-admission-medication-reconciliation-item/tambah">Tambah</Link>
        </Button>
      </div>
      <Table>
        <TableHeader>
