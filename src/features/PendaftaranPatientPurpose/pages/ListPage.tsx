...
const columns: ColumnDef<PatientPurpose, unknown>[] = [
  {
...
export function PatientPurposeListPage() {
  const resource = usePatientPurposeResource()
  const title = humanizeModuleName('PendaftaranPatientPurpose')

  return (
    <CrudDialogPage<PatientPurpose>
      title={title}
