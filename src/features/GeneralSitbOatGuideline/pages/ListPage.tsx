...
const columns: ColumnDef<SitbOatGuideline, unknown>[] = [
  {
...
export function SitbOatGuidelineListPage() {
  const resource = useSitbOatGuidelineResource()
  const title = humanizeModuleName('GeneralSitbOatGuideline')

  return (
    <CrudDialogPage<SitbOatGuideline>
      title={title}
