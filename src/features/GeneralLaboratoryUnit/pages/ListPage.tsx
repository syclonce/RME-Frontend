...
const columns: ColumnDef<LaboratoryUnit, unknown>[] = [
  {
...
export function LaboratoryUnitListPage() {
  const resource = useLaboratoryUnitResource()
  const title = humanizeModuleName('GeneralLaboratoryUnit')

  return (
    <CrudDialogPage<LaboratoryUnit>
      title={title}
