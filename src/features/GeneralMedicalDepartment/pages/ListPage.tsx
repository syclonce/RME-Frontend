...
const columns: ColumnDef<MedicalDepartment, unknown>[] = [
  {
...
export function MedicalDepartmentListPage() {
  const resource = useMedicalDepartmentResource()
  const title = humanizeModuleName('GeneralMedicalDepartment')

  return (
    <CrudDialogPage<MedicalDepartment>
      title={title}
