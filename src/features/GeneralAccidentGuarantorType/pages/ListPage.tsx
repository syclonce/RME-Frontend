...
const columns: ColumnDef<AccidentGuarantorType, unknown>[] = [
  {
...
export function AccidentGuarantorTypeListPage() {
  const resource = useAccidentGuarantorTypeResource()
  const title = humanizeModuleName('GeneralAccidentGuarantorType')

  return (
    <CrudDialogPage<AccidentGuarantorType>
      title={title}
