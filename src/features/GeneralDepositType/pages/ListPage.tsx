...
const columns: ColumnDef<DepositType, unknown>[] = [
  {
...
export function DepositTypeListPage() {
  const resource = useDepositTypeResource()
  const title = humanizeModuleName('GeneralDepositType')

  return (
    <CrudDialogPage<DepositType>
      title={title}
