...
const columns: ColumnDef<PrescriptionType, unknown>[] = [
  {
...
export function PrescriptionTypeListPage() {
  const resource = usePrescriptionTypeResource()
  const title = humanizeModuleName('GeneralPrescriptionType')

  return (
    <CrudDialogPage<PrescriptionType>
      title={title}
