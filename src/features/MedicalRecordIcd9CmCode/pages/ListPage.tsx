...
const columns: ColumnDef<Icd9CmCode, unknown>[] = [
  {
...
export function Icd9CmCodeListPage() {
  const resource = useIcd9CmCodeResource()
  const title = humanizeModuleName('MedicalRecordIcd9CmCode')

  return (
    <CrudDialogPage<Icd9CmCode>
      title={title}
