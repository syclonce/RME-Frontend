...
const columns: ColumnDef<TariffType, unknown>[] = [
  {
...
export function TariffTypeListPage() {
  const resource = useTariffTypeResource()
  const title = humanizeModuleName('GeneralTariffType')

  return (
    <CrudDialogPage<TariffType>
      title={title}
