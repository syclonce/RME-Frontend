...
const columns: ColumnDef<OperationGroup, unknown>[] = [
  {
...
export function OperationGroupListPage() {
  const resource = useOperationGroupResource()
  const title = humanizeModuleName('GeneralOperationGroup')

  return (
    <CrudDialogPage<OperationGroup>
      title={title}
