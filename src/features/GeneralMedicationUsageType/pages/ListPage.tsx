...
const columns: ColumnDef<MedicationUsageType, unknown>[] = [
  {
...
export function MedicationUsageTypeListPage() {
  const resource = useMedicationUsageTypeResource()
  const title = humanizeModuleName('GeneralMedicationUsageType')

  return (
    <CrudDialogPage<MedicationUsageType>
      title={title}
