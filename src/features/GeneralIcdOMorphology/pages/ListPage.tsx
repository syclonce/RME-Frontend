...
const columns: ColumnDef<IcdOMorphology, unknown>[] = [
  {
...
export function IcdOMorphologyListPage() {
  const resource = useIcdOMorphologyResource()
  const title = humanizeModuleName('GeneralIcdOMorphology')

  return (
    <CrudDialogPage<IcdOMorphology>
      title={title}
