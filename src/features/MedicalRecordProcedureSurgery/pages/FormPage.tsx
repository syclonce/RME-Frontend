...
export function ProcedureSurgeryFormPage() {
  const { create } = useProcedureSurgeryResource()
  ...
  return (
    ...
    >
      <h1 className="text-lg font-semibold">Tambah ProcedureSurgery</h1>
      ...
      <div className="grid gap-1.5">
        ...
        <Input id="procedure_id" type="number" value={values.procedure_id ?? ''} onChange={(e) => setValues({ ...values, procedure_id: e.target.value === '' ? null : Number(e.target.value) })} />
      </div>
      <div className="grid gap-1.5">
