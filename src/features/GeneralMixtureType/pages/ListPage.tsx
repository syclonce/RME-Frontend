...
const columns: ColumnDef<MixtureType, unknown>[] = [
  {
...
export function MixtureTypeListPage() {
  const resource = useMixtureTypeResource()
  const title = humanizeModuleName('GeneralMixtureType')

  return (
    <CrudDialogPage<MixtureType>
      title={title}
