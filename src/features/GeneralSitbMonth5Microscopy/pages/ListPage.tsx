...
const columns: ColumnDef<SitbMonth5Microscopy, unknown>[] = [
  {
...
export function SitbMonth5MicroscopyListPage() {
  const resource = useSitbMonth5MicroscopyResource()
  const title = humanizeModuleName('GeneralSitbMonth5Microscopy')

  return (
    <CrudDialogPage<SitbMonth5Microscopy>
      title={title}
