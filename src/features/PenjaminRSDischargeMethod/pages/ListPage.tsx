...
const columns: ColumnDef<DischargeMethod, unknown>[] = [
  {
...
export function DischargeMethodListPage() {
  const resource = useDischargeMethodResource()
  const title = humanizeModuleName('PenjaminRSDischargeMethod')

  return (
    <CrudDialogPage<DischargeMethod>
      title={title}
