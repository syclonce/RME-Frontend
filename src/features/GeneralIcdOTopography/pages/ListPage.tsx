...
const columns: ColumnDef<IcdOTopography, unknown>[] = [
  {
...
export function IcdOTopographyListPage() {
  const resource = useIcdOTopographyResource()
  const title = humanizeModuleName('GeneralIcdOTopography')

  return (
    <CrudDialogPage<IcdOTopography>
      title={title}
