...
export function LabResultSummaryListPage() {
  const { useList } = useLabResultSummaryResource()
  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-lg font-semibold">LabResultSummary</h1>
        <Button asChild>
          <Link to="/modul/medical-record-lab-result-summary/tambah">Tambah</Link>
        </Button>
      </div>
      <Table>
        <TableHeader>
