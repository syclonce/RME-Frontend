...
const columns: ColumnDef<SitbEndMicroscopy, unknown>[] = [
  {
...
export function SitbEndMicroscopyListPage() {
  const resource = useSitbEndMicroscopyResource()
  const title = humanizeModuleName('GeneralSitbEndMicroscopy')

  return (
    <CrudDialogPage<SitbEndMicroscopy>
      title={title}
