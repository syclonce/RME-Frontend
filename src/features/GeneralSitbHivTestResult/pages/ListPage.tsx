...
const columns: ColumnDef<SitbHivTestResult, unknown>[] = [
  {
...
export function SitbHivTestResultListPage() {
  const resource = useSitbHivTestResultResource()
  const title = humanizeModuleName('GeneralSitbHivTestResult')

  return (
    <CrudDialogPage<SitbHivTestResult>
      title={title}
