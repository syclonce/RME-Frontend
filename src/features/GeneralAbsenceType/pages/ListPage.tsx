...
const columns: ColumnDef<AbsenceType, unknown>[] = [
  {
...
export function AbsenceTypeListPage() {
  const resource = useAbsenceTypeResource()
  const title = humanizeModuleName('GeneralAbsenceType')

  return (
    <CrudDialogPage<AbsenceType>
      title={title}
