  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-lg font-semibold">SickLeaveCertificate</h1>
        <Button asChild>
          <Link to="/modul/medical-record-sick-leave-certificate/tambah">Tambah</Link>
        </Button>
      </div>
      <Table>
        <TableHeader>
            ...
            <TableRow key={row.id}>
              ...
              <TableCell>
                <div className="flex items-center gap-2">
                  <Link to={`/modul/medical-record-sick-leave-certificate/${row.id}/edit`} className="text-primary underline">Ubah</Link>
                  <Button
                    type="button"
                    variant="ghost"
                    size="sm"
