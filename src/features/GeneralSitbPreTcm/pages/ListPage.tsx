...
const columns: ColumnDef<SitbPreTcm, unknown>[] = [
  {
...
export function SitbPreTcmListPage() {
  const resource = useSitbPreTcmResource()
  const title = humanizeModuleName('GeneralSitbPreTcm')

  return (
    <CrudDialogPage<SitbPreTcm>
      title={title}
