...
const columns: ColumnDef<PharmacyStatusType, unknown>[] = [
  {
...
export function PharmacyStatusTypeListPage() {
  const resource = usePharmacyStatusTypeResource()
  const title = humanizeModuleName('GeneralPharmacyStatusType')

  return (
    <CrudDialogPage<PharmacyStatusType>
      title={title}
