...
const columns: ColumnDef<BridgeType, unknown>[] = [
  {
...
export function BridgeTypeListPage() {
  const resource = useBridgeTypeResource()
  const title = humanizeModuleName('GeneralBridgeType')

  return (
    <CrudDialogPage<BridgeType>
      title={title}
