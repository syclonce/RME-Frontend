...
const columns: ColumnDef<MixturePackagingType, unknown>[] = [
  {
...
export function MixturePackagingTypeListPage() {
  const resource = useMixturePackagingTypeResource()
  const title = humanizeModuleName('GeneralMixturePackagingType')

  return (
    <CrudDialogPage<MixturePackagingType>
      title={title}
