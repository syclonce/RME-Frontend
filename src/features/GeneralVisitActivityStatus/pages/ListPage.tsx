...
const columns: ColumnDef<VisitActivityStatus, unknown>[] = [
  {
...
export function VisitActivityStatusListPage() {
  const resource = useVisitActivityStatusResource()
  const title = humanizeModuleName('GeneralVisitActivityStatus')

  return (
    <CrudDialogPage<VisitActivityStatus>
      title={title}
