  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        ...
        <Input id="radiology_claim_id" type="number" value={values.radiology_claim_id ?? ''} onChange={(e) => setValues({ ...values, radiology_claim_id: e.target.value === '' ? null : Number(e.target.value) })} />
      </div>
      <div className="grid gap-1.5">
