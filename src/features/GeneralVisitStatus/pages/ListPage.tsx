...
const columns: ColumnDef<VisitStatus, unknown>[] = [
  {
...
export function VisitStatusListPage() {
  const resource = useVisitStatusResource()
  const title = humanizeModuleName('GeneralVisitStatus')

  return (
    <CrudDialogPage<VisitStatus>
      title={title}
