...
const columns: ColumnDef<SitbHivStatusClassification, unknown>[] = [
  {
...
export function SitbHivStatusClassificationListPage() {
  const resource = useSitbHivStatusClassificationResource()
  const title = humanizeModuleName('GeneralSitbHivStatusClassification')

  return (
    <CrudDialogPage<SitbHivStatusClassification>
      title={title}
