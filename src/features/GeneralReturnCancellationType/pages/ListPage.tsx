...
const columns: ColumnDef<ReturnCancellationType, unknown>[] = [
  {
...
export function ReturnCancellationTypeListPage() {
  const resource = useReturnCancellationTypeResource()
  const title = humanizeModuleName('GeneralReturnCancellationType')

  return (
    <CrudDialogPage<ReturnCancellationType>
      title={title}
