...
const columns: ColumnDef<DischargeCondition, unknown>[] = [
  {
...
export function DischargeConditionListPage() {
  const resource = useDischargeConditionResource()
  const title = humanizeModuleName('GeneralDischargeCondition')

  return (
    <CrudDialogPage<DischargeCondition>
      title={title}
