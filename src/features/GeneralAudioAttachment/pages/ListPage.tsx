...
const columns: ColumnDef<AudioAttachment, unknown>[] = [
  {
...
export function AudioAttachmentListPage() {
  const resource = useAudioAttachmentResource()
  const title = humanizeModuleName('GeneralAudioAttachment')

  return (
    <CrudDialogPage<AudioAttachment>
      title={title}
