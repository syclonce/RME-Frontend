...
const columns: ColumnDef<PaymentTransactionType, unknown>[] = [
  {
...
export function PaymentTransactionTypeListPage() {
  const resource = usePaymentTransactionTypeResource()
  const title = humanizeModuleName('GeneralPaymentTransactionType')

  return (
    <CrudDialogPage<PaymentTransactionType>
      title={title}
