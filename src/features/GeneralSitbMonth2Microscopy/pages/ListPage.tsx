...
const columns: ColumnDef<SitbMonth2Microscopy, unknown>[] = [
  {
...
export function SitbMonth2MicroscopyListPage() {
  const resource = useSitbMonth2MicroscopyResource()
  const title = humanizeModuleName('GeneralSitbMonth2Microscopy')

  return (
    <CrudDialogPage<SitbMonth2Microscopy>
      title={title}
