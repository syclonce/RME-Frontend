...
const columns: ColumnDef<DiscountType, unknown>[] = [
  {
...
export function DiscountTypeListPage() {
  const resource = useDiscountTypeResource()
  const title = humanizeModuleName('GeneralDiscountType')

  return (
    <CrudDialogPage<DiscountType>
      title={title}
