...
const columns: ColumnDef<OperationClass, unknown>[] = [
  {
...
export function OperationClassListPage() {
  const resource = useOperationClassResource()
  const title = humanizeModuleName('GeneralOperationClass')

  return (
    <CrudDialogPage<OperationClass>
      title={title}
