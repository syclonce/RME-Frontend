...
const columns: ColumnDef<ReturnCancellationReason, unknown>[] = [
  {
...
export function ReturnCancellationReasonListPage() {
  const resource = useReturnCancellationReasonResource()
  const title = humanizeModuleName('GeneralReturnCancellationReason')

  return (
    <CrudDialogPage<ReturnCancellationReason>
      title={title}
