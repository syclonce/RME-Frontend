...
const columns: ColumnDef<MedicalPersonnelType, unknown>[] = [
  {
...
export function MedicalPersonnelTypeListPage() {
  const resource = useMedicalPersonnelTypeResource()
  const title = humanizeModuleName('GeneralMedicalPersonnelType')

  return (
    <CrudDialogPage<MedicalPersonnelType>
      title={title}
