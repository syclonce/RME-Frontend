...
const columns: ColumnDef<PatientStatus, unknown>[] = [
  {
...
export function PatientStatusListPage() {
  const resource = usePatientStatusResource()
  const title = humanizeModuleName('GeneralPatientStatus')

  return (
    <CrudDialogPage<PatientStatus>
      title={title}
