...
const columns: ColumnDef<DosageInstruction, unknown>[] = [
  {
...
export function DosageInstructionListPage() {
  const resource = useDosageInstructionResource()
  const title = humanizeModuleName('GeneralDosageInstruction')

  return (
    <CrudDialogPage<DosageInstruction>
      title={title}
