...
const columns: ColumnDef<ReferralType, unknown>[] = [
  {
...
export function ReferralTypeListPage() {
  const resource = useReferralTypeResource()
  const title = humanizeModuleName('GeneralReferralType')

  return (
    <CrudDialogPage<ReferralType>
      title={title}
