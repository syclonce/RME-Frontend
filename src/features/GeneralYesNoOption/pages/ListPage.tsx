...
const columns: ColumnDef<YesNoOption, unknown>[] = [
  {
...
export function YesNoOptionListPage() {
  const resource = useYesNoOptionResource()
  const title = humanizeModuleName('GeneralYesNoOption')

  return (
    <CrudDialogPage<YesNoOption>
      title={title}
