...
const columns: ColumnDef<SitbPreMicroscopy, unknown>[] = [
  {
...
export function SitbPreMicroscopyListPage() {
  const resource = useSitbPreMicroscopyResource()
  const title = humanizeModuleName('GeneralSitbPreMicroscopy')

  return (
    <CrudDialogPage<SitbPreMicroscopy>
      title={title}
