...
const columns: ColumnDef<VisitCancellationReason, unknown>[] = [
  {
...
export function VisitCancellationReasonListPage() {
  const resource = useVisitCancellationReasonResource()
  const title = humanizeModuleName('GeneralVisitCancellationReason')

  return (
    <CrudDialogPage<VisitCancellationReason>
      title={title}
