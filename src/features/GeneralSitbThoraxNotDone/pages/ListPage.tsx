...
const columns: ColumnDef<SitbThoraxNotDone, unknown>[] = [
  {
...
export function SitbThoraxNotDoneListPage() {
  const resource = useSitbThoraxNotDoneResource()
  const title = humanizeModuleName('GeneralSitbThoraxNotDone')

  return (
    <CrudDialogPage<SitbThoraxNotDone>
      title={title}
