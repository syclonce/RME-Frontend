...
const columns: ColumnDef<InsuranceCardType, unknown>[] = [
  {
...
export function InsuranceCardTypeListPage() {
  const resource = useInsuranceCardTypeResource()
  const title = humanizeModuleName('GeneralInsuranceCardType')

  return (
    <CrudDialogPage<InsuranceCardType>
      title={title}
